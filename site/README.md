...
Реализация сайта на ветке `codex/site-v1`, базовый коммит `d640c22c5f1d98f81925b5e7668fdb0b65da76c4`. Канонические инструкции находятся в `docs/TZ-AK-LOEWEN-gGmbH-v5-source-of-truth.md` на ветке `Ak-loewen`. Исторический v2-концепт используется только для сравнения визуального направления. Оригинальные концепты, логотипы и материалы не изменены.
...
- Anar Karimov и незаполненное имя второго тренера; явно подписанные AI-силуэты вместо вымышленных портретов и достижений.
...
Остаются неизвестными: имя тренера Самбо & ММА, биографии, достижения и юридические тексты. Контакты VALSET подтверждены; Telegram-номер показан текстом до проверки доступности перехода владельцем.
