# Datenschutzhinweise für den Telegram-Buchungsbot @ak_loewenbot — ENTWURF

**Arbeitsstand: Entwurf, nicht veröffentlicht.** Dieser Text ist eine praktische Vorlage und keine Rechtsberatung. Er wurde weder anwaltlich geprüft noch vom Verantwortlichen freigegeben. Vor einer Aktivierung müssen die offenen Punkte am Ende bestätigt, die richtige Fassung veröffentlicht und die Konfigurationswerte des Bots entsprechend gesetzt werden. Die Buchungsfunktion ist im Projekt bis zur Veröffentlichung technisch gesperrt.

**Entwurfs-/Einwilligungsversion:** `draft-2026-09-11` (nur ein Platzhalter aus dem Projekt; vor Veröffentlichung ersetzen oder ausdrücklich bestätigen).

## 1. Verantwortlicher und Kontakt

Verantwortlicher für die Verarbeitung über diesen Bot ist nach den derzeit vorliegenden Projektangaben:
...
Die registrierte Geschäftsanschrift sowie Registerdaten wurden am 15.09.2026 anhand öffentlich zugänglicher, registerbasierter Quellen gegengeprüft. Sofern zwischenzeitlich eine Registeränderung erfolgt, ist vor Veröffentlichung der aktuelle Registerstand maßgeblich.
...
Wir verarbeiten die Daten, um Informationen bereitzustellen, eine Trainingsanfrage entgegenzunehmen und zu bearbeiten, Rückfragen zu stellen, einen Termin zu bestätigen oder abzusagen, den Status der eigenen Anfrage anzuzeigen und Nachrichten an den richtigen privaten Telegram-Chat zuzustellen. Soweit die Verarbeitung zur Durchführung vorvertraglicher Maßnahmen auf Anfrage der betroffenen Person erforderlich ist, ist die geplante Rechtsgrundlage **Art. 6 Abs. 1 lit. b DSGVO**. Ob diese Rechtsgrundlage im Einzelfall passt, muss der Verantwortliche vor Veröffentlichung prüfen; erforderlichenfalls ist eine andere Rechtsgrundlage anzugeben.

Eine optionale Terminerinnerung wird nur nach einer gesonderten ausdrücklichen Auswahl eingerichtet. Als Rechtsgrundlage ist dafür **Art. 6 Abs. 1 lit. a DSGVO** vorgesehen. Die Auswahl kann über `/stop` für alle Anfragen oder über die Ausschalt-Schaltfläche bei der betreffenden Anfrage widerrufen werden. `/reminders` aktiviert Erinnerungen und ist keine Abmeldefunktion. Eine Erinnerung wird nicht allein deshalb angelegt, weil eine Anfrage eingereicht wurde.

Technische Protokollierung, Zustellsteuerung, Missbrauchsvermeidung, Authentifizierung der internen Bot-Endpunkte und die Sicherstellung eines stabilen und sicheren Betriebs können auf **Art. 6 Abs. 1 lit. f DSGVO** gestützt werden. Die konkreten berechtigten Interessen und eine Interessenabwägung sind vor Veröffentlichung vom Verantwortlichen zu prüfen und zu dokumentieren.

Bei Minderjährigen soll eine Anfrage durch einen Elternteil, eine gesetzlich sorgeberechtigte, gesetzliche oder sonst autorisierte vertretende Person gestellt werden. Der Bot erfasst die dafür vorgesehenen Angaben. Der Verantwortliche muss vor Veröffentlichung festlegen, wann und wie eine Vertretungsberechtigung geprüft wird und ob zusätzliche Anforderungen gelten.

## 5. Empfänger und eingesetzte Dienste

Für Betrieb und Zustellung werden nach dem derzeitigen technischen Entwurf insbesondere folgende Dienste eingesetzt:
...
Diese Aufzählung beschreibt die vorgesehenen technischen Dienste, nicht automatisch die vollständige rechtliche Empfängerliste. Vor Veröffentlichung sind die tatsächlich verwendeten Konten, Auftragsverarbeitungsverträge, Unterauftragnehmer, Datenverarbeitungsorte, Übermittlungen in Drittländer und gegebenenfalls erforderliche Garantien (einschließlich Standardvertragsklauseln) anhand der aktuellen Anbieterbedingungen und Verträge zu prüfen. Dieser Entwurf behauptet hierzu keine bestimmten Datenstandorte, DPA- oder SCC-Abdeckung und keine abschließende Liste weiterer Empfänger.
...
Eine alternative Kontaktmöglichkeit außerhalb von Telegram ist die E-Mail an **aklggmbh@gmail.com**. Vor Veröffentlichung muss der Verantwortliche bestätigen, wie Anfragen dort sicher zugeordnet und bearbeitet werden.
...
Personalantworten und Buchungsdetails werden nur für die Bearbeitung der Anfrage an dafür vorgesehene Personal-Chats übermittelt. Vor Aktivierung muss der Verantwortliche festlegen und dokumentieren, welche Personen Zugriff erhalten und wie Datenschutz in Gruppen-Chats (insbesondere bei ForceReply-Funktionen) gewährleistet wird.
...
# Русский перевод (рабочий перевод; приоритет имеет опубликованный немецкий текст)

**Статус: ПРОЕКТ, НЕ ОПУБЛИКОВАНО.** Это практический шаблон, а не юридическая консультация. Текст не проходил проверку юристом и не был утверждён ответственным лицом. До включения бота нужно подтвердить открытые вопросы в конце документа, опубликовать правильную версию и настроить бота соответственно. До публикации функция записи в проекте технически заблокирована.

**Версия проекта/согласия:** `draft-2026-09-11` (проектное значение; перед публикацией заменить или прямо подтвердить).

## 1. Ответственное лицо и контакты

По имеющимся данным проекта ответственным за обработку через бота является:
...
Адрес и регистрационные данные были перепроверены 15.09.2026 по открытым источникам, основанным на данных Handelsregister. Перед публикацией приоритет имеет самый свежий официальный реестровый статус.
...
Данные используются для информации, приёма и обработки заявки, уточняющих вопросов, подтверждения/отмены, просмотра статуса и доставки сообщений в правильный чат. Предполагаемое основание для необходимых преддоговорных действий — **ст. 6(1)(b) GDPR/DSGVO**, но его применимость в каждом случае должен проверить ответственный.

Необязательное напоминание включается только после отдельного явного выбора; планируемое основание — **ст. 6(1)(a) GDPR/DSGVO**. Его можно отключить через `/stop` для всех заявок или кнопкой отключения в конкретной заявке. Команда `/reminders` включает напоминания, а не отключает их. Сам факт подачи заявки не включает напоминание.

Техническая безопасность, аутентификация внутренних endpoint’ов, предотвращение злоупотреблений и стабильная доставка могут основываться на **ст. 6(1)(f) GDPR/DSGVO**; конкретный законный интерес и баланс интересов нужно документировать до публикации.

Заявку несовершеннолетнего должен подавать родитель, опекун или другой уполномоченный представитель. До публикации ответственный должен определить, как проверяется такое полномочие.
...
Уведомление нужно опубликовать на постоянно доступном HTTPS-адресе, выбранном ответственным лицом. Версия на странице должна совпадать с версией, которую показывает бот. Изменения целей, оснований, получателей, хранения или прав нужно проверить заранее и при необходимости получить новое подтверждение.

---

## Открытые вопросы перед публикацией (не являются частью опубликованного уведомления)

Реестровые и контактные данные компании уже заполнены. Остаётся:

1. Финально утвердить правовые основания обработки (включая Art. 6(1)(b)/(a)/(f)), правила для заявок несовершеннолетних и отдельного напоминания.
2. Перед production проверить фактически используемые Telegram/Vercel/Upstash аккаунты, тарифы, регионы, DPA/субподрядчиков и международные передачи. Tasklet не считать production-получателем, если он остаётся только инструментом разработки.
3. Утвердить фактический механизм доступа сотрудников и безопасное использование staff/group chats.
4. Утвердить публичный HTTPS-URL Datenschutzhinweise, финальную версию/идентификатор и процедуру обработки запросов на удаление.
5. Только после этого переключить privacy gate в приложении на `published`; не обходить его вручную.

Для Impressum отдельно остаётся проверить у бухгалтерии/Steuerberater, присвоены ли компании **USt-IdNr.** и/или **W-IdNr.**. В открытом поиске на 15.09.2026 эти номера достоверно не обнаружены; их нельзя угадывать или восстанавливать по названию компании.
