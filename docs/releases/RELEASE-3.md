...
- После валидного нажатия inline-кнопки бот удаляет устаревшую интерфейсную карточку и затем отправляет следующий экран. Тексты пользователя и важные ответы тренера автоматически не удаляются.
